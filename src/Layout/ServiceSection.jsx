...
export default function ServiceSection() {
  ...
  return (
    <>
        ...
        <div className="w-full mt-8 h-fit">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              className={`${
                selectedTab == "app" ? "rotate-180" : "rotate-0"
          ...
          <div
            className={`${
              selectedTab == "app" ? "h-80" : "h-0"
            } transition-all duration-200 w-full overflow-hidden`}
          >
            <h3 className="mt-3 text-sm leading-loose">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              className={`${
                selectedTab == "web" ? "rotate-180" : "rotate-0"
              } transition-all duration-200`}
            >
              <g
                fill="none"
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              className={`${
                selectedTab == "dm" ? "rotate-180" : "rotate-0"
              } transition-all duration-200`}
            >
              <g
                fill="none"
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              className={`${
                selectedTab == "ui" ? "rotate-180" : "rotate-0"
              } transition-all duration-200`}
            >
              <g
                fill="none"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3
                className={`${
                  selectedTab == "design" ? "font-semibold" : ""
                } transition-all`}
              >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              className={`${
                selectedTab == "design" ? "rotate-180" : "rotate-0"
              } transition-all duration-200`}
            >
              <g
                fill="none"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3
                className={`${
                  selectedTab == "software" ? "font-semibold" : ""
                } transition-all`}
              >
            ...
            <svg
              ...
              viewBox="0 0 48 48"
              className={`${
                selectedTab == "software" ? "rotate-180" : "rotate-0"
              } transition-all duration-200`}
            >
              <g
                fill="none"
      ...
      <div className="w-[90%] h-fit mx-auto jamjuree md:block hidden">
        <h3 className="text-2xl md:text-4xl font-semibold">Services</h3>
        <div className="w-full mt-8 h-fit">
          <div className="w-1/2">
            <div
